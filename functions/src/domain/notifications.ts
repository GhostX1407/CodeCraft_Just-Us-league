...
export type RecipientRole = 'ambulance' | 'hospital' | 'admin' | 'family';
...
export class NotificationRepository {
  ...
  static async listForRole(
    ...
    snapshot.forEach((doc: FirebaseFirestore.QueryDocumentSnapshot) => {
      ...
      // Match role
      if (data.recipientRole === role || data.recipientRole === 'admin') {
        if (!recipientId || !data.recipientId || data.recipientId === 'all' || data.recipientId === recipientId) {
